  ...
  mn: {
    ...
    siteContent: {
      ...
      about: {
        sections: {
          ...
          image: "Зураг",
          copy: "Танилцуулга ба Ишлэл",
          stats: "Давуу тал (Features)",
        },
        fields: {
          ...
          yearsLabel: "Ишлэлийн эх сурвалж",
        },
      },
      services: {
        sections: {
      ...
      ajluud: {
        ...
        fields: {
          badge: "Badge (дээд шошго)",
          titleLine1: "Гарчиг",
          titleAccent: "Гарчиг онцлох (хоосон бол автомат)",
          id: "ID",
          title: "Нэр",
          category: "Ангилал",
          image: "Зураг",
    ...
    qrPortal: {
      ...
      sections: {
        ...
        descriptions: "Хуудасны тайлбар",
        branding: "Өнгө төрх",
      },
      fields: {
        ios: "iOS App (App Store) холбоос",
        android: "Android (Play Store) холбоос",
        facebook: "Facebook холбоос",
        facebookName: "Facebook нэр (Дэлгэцэнд харагдах)",
        instagram: "Instagram холбоос",
      ...
      messages: {
        ...
        saving: "Хадгалж байна...",
        success: "QR Портал амжилттай шинэчлэгдлээ!",
  ...
  en: {
    ...
    qrPortal: {
      ...
      fields: {
        ...
        facebookName: "Facebook Name (Display)",
      ...
      messages: {
        ...
        saving: "Saving...",
        success: "QR Portal updated successfully!",
